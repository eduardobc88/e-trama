...
import ProxyResponse from '../http/response.js'
...
class Collection extends Base {
  ...
  set(attribute, value) {
    ...
    set(this._attributes, attribute, value);
  }
  ...
  _removeModelAtIndex(index) {
    ...
    this.models.splice(index, 1); // NOTE: UPDATED REMOVING FROM ARRAY AND NOT USING DELETE
    // delete this.models[index]; // NOTE: UNCOMMENT FOR DEFAULT
    this.onRemove(model);
