...
const post = async (req, res) => {
  ...
  try {
    req.body.custom_list_id = ((req.body.custom_list_id === 0)?null:req.body.custom_list_id)
    req.body.custom_entity_id = ((req.body.custom_entity_id === 0)?null:req.body.custom_entity_id)
    req.body.custom_entity_field_id = ((req.body.custom_entity_field_id === 0)?null:req.body.custom_entity_field_id)
