...
const add = async data => {
  ...
  try {
    ...
    let [result] = await transaction.query(COMMAND.create, {
      ...
      custom_list_id: data.record.custom_list_id,
      custom_entity_id: data.record.custom_entity_id,
      custom_entity_field_id: data.record.custom_entity_field_id,
    })
...
const update = async data => {
  ...
  try {
    ...
    await transaction.query(COMMAND.update,[
      ...
      data.record.type,
      data.record.custom_list_id,
      data.record.custom_entity_id,
      data.record.custom_entity_field_id,
      data.record.id,
    ])
    await transaction.commit()
    response = await find({
